...
local function LoadConfiguration(Configuration)
	...
	for FlagName, FlagValue in next, Data do
		if RayfieldLibrary.Flags[FlagName] then
			...
			RayfieldLibrary:Notify({Title = "Flag Error", Content = "VoidCodex was unable to find '"..FlagName.. "'' in the current script. Check docs.sirius.menu for help."})
		end
	end
end
			...
			for _, Action in pairs(NotificationSettings.Actions) do
				...
				NewAction.MouseButton1Click:Connect(function()
					...
					if not Success then
						...
						warn('Check discord.gg/n3kE8gMkjx for help with VoidCodex specific development.')
					end
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "VoidCodex Hub"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "by VoidCodex"
	...
	function Window:CreateTab(Name,Image)
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			local togglePosition = Toggle.Position -- Posição atual do Toggle
			local xOffset = 10 -- ajuste horizontal
			local yOffset = 5 -- ajuste vertical
			
			Toggle.Title.Position = UDim2.new(
			    togglePosition.X.Scale,
			    togglePosition.X.Offset + xOffset,
			    togglePosition.Y.Scale,
			    togglePosition.Y.Offset + yOffset
			)
			Toggle.Visible = true
